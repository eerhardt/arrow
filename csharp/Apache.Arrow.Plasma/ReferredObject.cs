...
{
    public class ReferredObject
    {
        private PlasmaReferredObjectSafeHandle _handle;

        internal ReferredObject(PlasmaReferredObjectSafeHandle handle)
        {
        ...
        // TODO: This should be a immutable ObjectStoreData
